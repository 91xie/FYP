...
class Example(Frame):
    ...
    def initUI(self):
        ...
        #<Buttonsand the functions are initiated here>
        ...
        #The functions that each button do are created below.
        #note command=self.onError for e
        #</Buttons and the functions are initiated here>

    #<self functions are defined here>
    def onError(self):
    ...
    #These functions are used in the command input for
        #Button
    #</self functions are defined here>
